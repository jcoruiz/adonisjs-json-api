'use strict'
    ...
    class V1 extends genderBase {
      tableSchema () {
        return {"tableName":"core_gender","fields":[{"fieldName":"id"},{"fieldName":"name"},{"fieldName":"code"},{"fieldName":"dt_cre"},{"fieldName":"dt_mod"},{"fieldName":"deleted"},{"fieldName":"active"}],"columns":["id","name","code","dt_cre","dt_mod","deleted","active"]}
      }
       ...
       * @description
       * Create an Entity in the table gender
       * 
      ...
      */
       ...
       * @version V1
       * @description
       * Update an Entity in the table gender
       * <b>Estados de resultado</b>
       * <table>
       *  <tr>
       *    <th>Estado</th>
       ...
       * @example <caption>Request:</caption>
       * {@lang bash}
       * PATCH {Protocol}://{Server}:{Port}/{Client}/{Version}/core/gender/{id}
       * {
       *    "data" : {
       *      "type": "core_gender",
       *      "id": "{id}",
      ...
      */
       ...
       * @version V1
       * @description
       * Delete Entity (Logical) in the table gender
       * 
       * <b>Estados de resultado</b>
       * <table>
       *  <tr>
       ...
       * @example <caption>Request:</caption>
       * {@lang bash}
       * DELETE {Protocol}://{Server}:{Port}/{Client}/{Version}/core/gender/{id}
       * 
      ...
      */
       ...
       * @version V1
       * @description
       * Read an Entity in the table gender
       * @example <caption>Request:</caption>
       * {@lang bash}
       * POST: {Protocol}://{Server}:{Port}/{Client}/{Version}/core/gender/{id}
       * 
       * @example <caption>Response:</caption>
       * {@lang json}
       * [
